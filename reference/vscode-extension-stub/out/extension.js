...
function activate(context) {
    ...
    async function handleSSHError() {
        const troubleshoot = await vscode.window.showErrorMessage('Unable to connect to Fly Dev environment', {
            modal: true,
	...
	Port 2222`;
            ...
            await vscode.workspace.fs.writeFile(vscode.Uri.file(`${process.env.HOME}/.ssh/config`), Buffer.from(sshConfig + '\n', 'utf8'));
            ...
            try {
                ...
                await vscode.window.withProgress({
                    ...
                    // Attempt connection
                    await vscode.commands.executeCommand('vscode.openFolder', vscode.Uri.parse(`vscode-remote://ssh-remote+localhost/home/dev`), { forceNewWindow: false });
